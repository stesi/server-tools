...
class TestTrackingManager(SavepointCase):
    ...
    def test_o2m_create_indirectly(self):
        ...
        self.assertEqual(self.messages.mapped('body').count("New"), 1)

    def test_o2m_unlink_indirectly(self):
        self.partner.write({"bank_ids": [(2, self.partner.bank_ids[0].id)]})
        self.assertEqual(len(self.messages), 2)
        self.assertIn("Delete", self.messages.mapped('body'))
    ...
    def test_o2m_write_indirectly(self):
        ...
        self.assertEqual(len(self.messages), 2)
        self.assertIn("Change", self.messages.mapped('body'))
    ...
    def test_o2m_create_and_unlink_indirectly(self):
        ...
        self.assertEqual(self.messages.mapped('body').count("New"), 1)
        self.assertEqual(self.messages.mapped('body').count("Delete"), 1)
    ...
    def test_o2m_update_m2m_indirectly(self):
        ...
        self.assertEqual(len(self.messages), 1)
        self.assertEqual(self.messages.mapped('body').count("Changed"), 1)
    ...
    def test_o2m_write_and_unlink_indirectly(self):
        ...
        self.assertEqual(len(self.messages), 3)
        self.assertEqual(self.messages.mapped('body').count("Change"), 0)
        self.assertEqual(self.messages.mapped('body').count("Delete"), 1)
    ...
    def test_o2m_update_directly(self):
        ...
        self.assertEqual(len(self.messages), 2)
        self.assertEqual(self.messages.mapped('body').count("Change :"), 1)
